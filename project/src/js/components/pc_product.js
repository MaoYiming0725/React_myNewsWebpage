	...
	render(){
        ...
        <div className="tab_main no_login_tabmain">
          ...
          <div className="cell cell_app">
            {/* 前三个位置随机，最后一个位置固定 */}
            <ul id="app_list">
              <li className="hongcai_app"><a href="https://hongcai.163.com/?from=pcsy-button"><i /><span>网易红彩</span></a></li><li className="gongkaike_app"><a href="http://open.163.com/appdownload/mobile?news_other"><i /><span>公开课</span></a></li><li className="bohe_app"><a href="http://live.ent.163.com/download?f=163.homeMyApp"><i /><span>网易薄荷</span></a></li><li className="bolo_app"><a href="http://bolo.163.com"><i /><span>网易菠萝</span></a></li></ul>
